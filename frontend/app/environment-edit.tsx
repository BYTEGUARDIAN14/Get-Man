...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: 'Lora_500Medium', fontSize: 18, color: Colors.TEXT_PRIMARY, flex: 1 },
  saveText: { fontFamily: 'DMSans_500Medium', fontSize: 14, color: Colors.ACCENT },
  content: { flex: 1, paddingHorizontal: 16 },
  label: { fontFamily: 'DMSans_500Medium', fontSize: 13, color: Colors.TEXT_MUTED, marginBottom: 8, textTransform: 'uppercase', letterSpacing: 1 },
  input: { backgroundColor: Colors.BACKGROUND_ELEVATED, borderWidth: 1, borderColor: Colors.BORDER, borderRadius: 6, paddingHorizontal: 12, paddingVertical: 10, fontFamily: 'DMSans_400Regular', fontSize: 14, color: Colors.TEXT_PRIMARY },
