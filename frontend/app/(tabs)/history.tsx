...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontFamily: 'IBMPlexMono_500Medium', fontSize: 13, color: Colors.TEXT_MUTED, paddingVertical: 8, paddingHorizontal: 16, backgroundColor: Colors.BACKGROUND_BASE },
  ...
  clearText: { fontFamily: 'IBMPlexMono_500Medium', fontSize: 14, color: Colors.ERROR },
});
