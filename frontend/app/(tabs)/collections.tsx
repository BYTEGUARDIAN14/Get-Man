...
const styles = StyleSheet.create({
  ...
  newBtn: { fontFamily: 'IBMPlexMono_500Medium', fontSize: 14, color: Colors.ACCENT },
  ...
  searchInput: { flex: 1, paddingVertical: 8, marginLeft: 8, fontFamily: 'IBMPlexMono_400Regular', fontSize: 14, color: Colors.TEXT_PRIMARY },
  ...
  cardName: { fontFamily: 'IBMPlexMono_500Medium', fontSize: 14, color: Colors.TEXT_PRIMARY },
  cardSub: { fontFamily: 'IBMPlexMono_400Regular', fontSize: 12, color: Colors.TEXT_MUTED, marginTop: 2 },
  ...
  reqName: { flex: 1, fontFamily: 'IBMPlexMono_400Regular', fontSize: 13, color: Colors.TEXT_PRIMARY },
