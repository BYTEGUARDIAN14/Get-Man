...
const styles = StyleSheet.create({
  ...
  cardLeft: { flex: 1 },
  envName: { fontFamily: 'DMSans_500Medium', fontSize: 14, color: Colors.TEXT_PRIMARY },
  envSub: { fontFamily: 'DMSans_400Regular', fontSize: 12, color: Colors.TEXT_MUTED, marginTop: 2 },
  ...
  editText: { fontFamily: 'DMSans_500Medium', fontSize: 13, color: Colors.ACCENT },
