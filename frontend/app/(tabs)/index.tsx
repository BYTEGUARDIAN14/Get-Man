...
const styles = StyleSheet.create({
  ...
  greeting: { fontFamily: 'IBMPlexMono_600SemiBold', fontSize: 22, color: Colors.TEXT_PRIMARY },
  date: { fontFamily: 'IBMPlexMono_400Regular', fontSize: 13, color: Colors.TEXT_MUTED, marginTop: 4, marginBottom: 20 },
  newBtn: { borderRadius: 10, paddingVertical: 14, alignItems: 'center', marginBottom: 16 },
  newBtnText: { fontFamily: 'IBMPlexMono_600SemiBold', fontSize: 15, color: Colors.TEXT_PRIMARY },
